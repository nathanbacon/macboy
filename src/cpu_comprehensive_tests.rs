use crate::{cartridge::MBC3, cpu::CPU, gpu::VRAM, mmu::MMU, registers::Registers, opcodes::{Opcode, ExtendedOpcode}};
...
fn test_ld_r_r_all_combinations() {
    ...
    let ld_opcodes = [
        ...
        [Opcode::LdAB, Opcode::LdAC, Opcode::LdAD, Opcode::LdAE, Opcode::LdAH, Opcode::LdAL, Opcode::LdAA],
    ];
...
fn test_ld_r_n_all_registers() {
    let opcodes = [Opcode::LdBN, Opcode::LdCN, Opcode::LdDN, Opcode::LdEN, Opcode::LdHN, Opcode::LdLN, Opcode::LdAN];
    let registers = ['b', 'c', 'd', 'e', 'h', 'l', 'a'];
...
fn test_add_a_r_comprehensive() {
    let opcodes = [Opcode::AddAB, Opcode::AddAC, Opcode::AddAD, Opcode::AddAE, Opcode::AddAH, Opcode::AddAL, Opcode::AddAA];
    let registers = ['b', 'c', 'd', 'e', 'h', 'l', 'a'];
